...
?>
      ...
      <main>
        ...
        <div id="reviews" class="reviews-line">
          <div>
          ...
          <div class="slider flex-box horizontal-nav">
            <ul class="slides">
              ...
              for ($i = 0; $i < $num; $i = $i + 2) {
                ?><li>
                <div>
                  <div class="reviews-line-text">
                    <i><?=$arr[$i]['text'];?></i>
                  </div>
                  <div>
                    <img src="<?=PROJECT_URL . $arr[$i]['avatar'];?>" alt="Фото автора" /> <?=$arr[$i]['name'];?>
                  </div>
                </div>
                <div>
                  <div class="reviews-line-text">
                  ...
                  <div>
                    <img src="<?=PROJECT_URL . $arr[$i + 1]['avatar'];?>" alt="Фото автора" /> <?=$arr[$i + 1]['name'];?>
                  </div>
                </div>
              </li>
              <?php }
